...
clt::Texture* clt::AssetManager::LoadTexture(const std::string& path, const std::string& name, const TextureFilter texFilter, const bool generateMipMaps, const bool flipVertically)
{
    return nullptr;
}

clt::Texture* clt::AssetManager::GetTexture(const std::string& name)
{
    return nullptr;
}
